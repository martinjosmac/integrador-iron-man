/*
 */
package ServiciosIntegrador;

import integradorironman.Entidades.Armadura;
import integradorironman.Entidades.ObjetosVarios;
...
//Random.
    ...
    public void agregarObjetos() {
        ...
        ObjetosVarios o8 = new ObjetosVarios("persona", (float) (Math.random() * 50000), (float) (Math.random() * 50000), true);
        ObjetosVarios o9 = new ObjetosVarios("avion2", (float) (Math.random() * 50000), (float) (Math.random() * 50000), true);
